function [results_subj,C,cost_fun,varexpl,time_taken]=MSAA_T(subj,noc,varargin)
...
ind_t=i;
sum_dist=zeros(1,J);
if J>I % Fast implementation for large scale number of observations. Can be improved by reusing calculations
    Kt=K;    
    Kt2=sum(Kt.^2);
    for k=1:noc+10            
