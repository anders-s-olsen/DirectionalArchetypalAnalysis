...
matlabbatch{7}.spm.meeg.averaging.average.D(1) = cfg_dep('Prepare: Prepared Datafile', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','Dfname'));
matlabbatch{7}.spm.meeg.averaging.average.userobust.standard = false;
matlabbatch{7}.spm.meeg.averaging.average.plv = false;
matlabbatch{7}.spm.meeg.averaging.average.prefix = 'm';
matlabbatch{8}.spm.meeg.averaging.contrast.D(1) = cfg_dep('Averaging: Averaged Datafile', substruct('.','val', '{}',{7}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','Dfname'));
matlabbatch{8}.spm.meeg.averaging.contrast.contrast(1).c = [1 0 0];
matlabbatch{8}.spm.meeg.averaging.contrast.contrast(1).label = 'Famous';
matlabbatch{8}.spm.meeg.averaging.contrast.contrast(2).c = [0 1 0];
matlabbatch{8}.spm.meeg.averaging.contrast.contrast(2).label = 'Unfamiliar';
matlabbatch{8}.spm.meeg.averaging.contrast.contrast(3).c = [0 0 1];
matlabbatch{8}.spm.meeg.averaging.contrast.contrast(3).label = 'Scrambled';
matlabbatch{8}.spm.meeg.averaging.contrast.contrast(4).c = [0.5 0.5 -1];
matlabbatch{8}.spm.meeg.averaging.contrast.contrast(4).label = 'Faces-Scrambled';
matlabbatch{8}.spm.meeg.averaging.contrast.contrast(5).c = [1 -1 0];
matlabbatch{8}.spm.meeg.averaging.contrast.contrast(5).label = 'Famous-Unfamiliar';
